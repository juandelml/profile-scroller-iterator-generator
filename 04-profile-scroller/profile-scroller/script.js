...
nextBtn.addEventListener('click', () => {
    ...
    profileInfo.querySelectorAll('p')[0].textContent = `${person.age} años`;
    profileInfo.querySelectorAll('p')[1].textContent = `De ${person.location}`;
    profileInfo.querySelectorAll('p')[2].textContent = person.gender === 'female' ? 'Mujer interesada en hombres' : 'Hombre interesado en mujeres';
});
